...
<p align="center">
    <a herf="https://github.com/oVo-HxBots/oVo-FileStreamBot">
...
- [![Deploy To Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/oVo-HxBots/oVo-FileStreamBot)
...
```sh
git clone https://github.com/oVo-HxBots/oVo-FileStreamBot
cd oVo-FileStreamBot
...
`WORKERS` : Number of maximum concurrent workers for handling incoming updates. Defaults to `6`
...
[![Telegram Channel](https://img.shields.io/static/v1?label=Join&message=Telegram%20Channel&color=blueviolet&style=for-the-badge&logo=telegram&logoColor=violet)](https://telegram.me/HxBots)
[![Telegram Group](https://img.shields.io/static/v1?label=Join&message=Telegram%20Group&color=blueviolet&style=for-the-badge&logo=telegram&logoColor=violet)](https://telegram.me/HxSupport)

You can contact either via my [Telegram Group](https://telegram.me/HxSupport) or you can PM me on [@Kirodewal](https://telegram.me/kirodewal)
